...
fn main() {
    ...
    lowpass_samples.push_all(&*quantize_samples::<i16>(convolve(lowpass, sample.clone())));
    ...
    highpass_samples.push_all(&*quantize_samples::<i16>(convolve(highpass, sample.clone())));
    ...
    bandpass_samples.push_all(&*quantize_samples::<i16>(convolve(bandpass, sample.clone())));
    ...
    bandreject_samples.push_all(&*quantize_samples::<i16>(convolve(bandreject, sample.clone())));
